...
var ImgClip$1 = function () {
    ...
    _createClass(ImgClip, [{
        ...
        value: function getRealFinalImgSize(curWidth, curHeight) {
            ...
            if (this.rotateStep & 1) {
                ...
                if (maxWidth && this.canvasFull.height > maxWidth && maxWidth < this.img.height) {
                    ...
                    width = maxWidth / wPerH * curHeight / this.canvasFull.width;
                    height = maxWidth * curWidth / this.canvasFull.height;
					console.log("?_1 width",width);
					console.log("?_1 height",height);
                }
                if (forceWidth) {
                    // 使用固定宽
        ...
        value: function clip() {
			...
			console.log("this.rotateStep",this.rotateStep);
